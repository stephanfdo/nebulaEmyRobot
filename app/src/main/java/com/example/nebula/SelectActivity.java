...
public class SelectActivity extends TopBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            textView.setText("If you want to know about more information about SLT Mobitel embryo innovation centre please say yes!");
    ...
    public void speechlistner(){
        speechManager.setOnSpeechListener(new RecognizeListener() {
            ...
            public boolean onRecognizeResult(Grammar grammar) {
                ...
                Toast.makeText(SelectActivity.this,grammer1, Toast.LENGTH_SHORT).show();
                if ("yes".equals(grammer1)) {
                    ...
                    Toast.makeText(SelectActivity.this, "not detect", Toast.LENGTH_SHORT).show();
                }
                return true;
            }
    ...
    public void speechTest(){
        speechManager.setOnSpeechListener(new WakenListener() {
            ...
            public void onWakeUp() {
                Toast.makeText(SelectActivity.this, "listner wakeup", Toast.LENGTH_SHORT).show();
            }
            @Override
            public void onSleep() {
                Toast.makeText(SelectActivity.this, "listner sleep", Toast.LENGTH_SHORT).show();
                    speechManager.doWakeUp();
                    speechlistner();
