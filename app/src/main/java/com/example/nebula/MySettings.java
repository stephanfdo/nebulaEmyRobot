...
import static com.example.nebula.MyUtilsXML.createFileInXMLDirectory;
import static com.example.nebula.MyUtilsXML.xmlAddToNodeNow;
import static com.example.nebula.MyUtilsXML.xmlReadStatsHandshakesNumber;
...
public class MySettings {
    ...
    public static boolean initializeSpeak() {
        ...
        speakDefaultOption.setSpeed(40); //from 0 to 100 default: 40
        speakDefaultOption.setIntonation(50); //from 0 to 100 default: 30
        return true;
    }
